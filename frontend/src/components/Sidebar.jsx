...
export default function Sidebar({ onSuggest, onSendMessage, onLoadHistory, refreshTrigger, isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`
        fixed inset-y-0 left-0 z-50 w-72 bg-[var(--bg-sidebar)] border-r border-[var(--border-light)] 
